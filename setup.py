...
------------
  ...
  * `ElementTree http://effbot.org/zone/element-index.htm`_ which you'll have automatically if you run Python 2.5 or greater.

""",
    author='Scott Kirkwood',
    author_email='scottakirkwood@gmail.com',
    url='http://code.google.com/p/%s/' % NAME,
    download_url='http://mm2notes.googlecode.com/files/%ss-0.1.0.zip' % NAME,
